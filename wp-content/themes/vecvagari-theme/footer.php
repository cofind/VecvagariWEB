			...
			<div class="vv-footer-col vv-footer-brand">
				...
				<ul class="vv-footer-contact-list" aria-label="<?php echo esc_attr( vv_t( 'Adrese', 'Address', 'Adress' ) ); ?>">
					<li class="vv-footer-contact-item">
						...
						<span><?php echo esc_html( vv_contact( 'address', 'Dzirnavu 13, Saldus, LV-3801' ) ); ?></span>
					</li>
				</ul>
			...
			<div class="vv-footer-col vv-footer-contacts">
				...
				<ul class="vv-footer-contact-list">
					<li class="vv-footer-contact-item">
						...
						<a href="mailto:<?php echo esc_attr( vv_contact( 'email', 'info@vecvagari.com' ) ); ?>"><?php echo esc_html( vv_contact( 'email', 'info@vecvagari.com' ) ); ?></a>
					</li>
					<li class="vv-footer-contact-item">
						<span class="vv-footer-contact-icon" aria-hidden="true">
						...
						<a href="tel:<?php echo esc_attr( preg_replace( '/[^+\d]/', '', vv_contact( 'phone_office', '+37125590827' ) ) ); ?>"><?php echo esc_html( vv_contact( 'phone_office', '+371 25590827' ) ); ?></a>
					</li>
				</ul>

				<div class="vv-footer-social" aria-label="<?php echo esc_attr( vv_t( 'Sociālie tīkli', 'Social media', 'Sociala medier' ) ); ?>">
					<a href="<?php echo esc_url( vv_contact( 'social_facebook', 'https://www.facebook.com/vecvagari' ) ); ?>" class="vv-social-link" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
					...
					<a href="<?php echo esc_url( vv_contact( 'social_instagram', 'https://www.instagram.com/vecvagari' ) ); ?>" class="vv-social-link" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
						<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
					</a>
					<a href="<?php echo esc_url( vv_contact( 'social_linkedin', 'https://www.linkedin.com/company/vecvagari' ) ); ?>" class="vv-social-link" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
					...
					<a href="<?php echo esc_url( vv_contact( 'social_youtube', 'https://www.youtube.com/@vecvagari' ) ); ?>" class="vv-social-link" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
